      ...
      <main className="pt-24 pb-16 lg:pt-32 lg:pb-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            {/* Email Signup Form */}
            <div className="mt-10 max-w-md mx-auto animate-fade-in-up stagger-4">
              {isSuccess ? (
                <div className="flex flex-col items-center gap-4 p-6 rounded-2xl bg-success/10 border border-success/20">
